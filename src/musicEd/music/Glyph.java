...
public class Glyph{
    ...
    public static Glyph BRACE = new Glyph((char)61473, 16, 0, 4);  // 61473: unicode
    ...
    public static Glyph HEAD_HALF = new Glyph((char)61485, 16, 0, 7);  //0 -> 7
    public static Glyph HEAD_Q = new Glyph((char)61486, 16, 0, 7);  // quater node head
    public static Glyph HEAD_W = new Glyph((char)61484, 16, 0, 7);  // whole node head
